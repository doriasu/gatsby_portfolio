      ...
      <div className="grid grid-cols-2 gap-4 pb-4">
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-4 pb-4">
            <div>pic</div>
            <div className="col-span-2">
                          2021/3/1~2021/3/12<br />
                          Open Hack U Online Vol.4にて友人と3人チームで制作しました。オンライン環境下での発表支援ツールです。母音を特徴量とした話す速度の可視化機能や原稿を読む速度のレコメンド機能などを
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-4 pb-4">
            <div>pic</div>
                      <div className="col-span-2">
                          2020/10/31~2020/11/7<br />2020/11/13~2020/11/27<br /> 
